...
namespace Goliath
{
    ...
    {
        GoliathAI owner;
        public ragedState(GoliathAI owner) { this.owner = owner; }
        public void Enter()
        {
            owner.SFX_seen.Play();
    ...
    {
        GoliathAI owner;
        public attackState(GoliathAI owner) { this.owner = owner; }
    ...
    {
        GoliathAI owner;
        public jumpState(GoliathAI owner) { this.owner = owner; }
        public void Enter()
        {
    ...
    {
        GoliathAI owner;
        public hurtState(GoliathAI owner) { this.owner = owner; }
